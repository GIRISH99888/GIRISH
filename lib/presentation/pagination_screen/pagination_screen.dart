            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                    child: Container(
                      ...
                      Container(
                          height: getVerticalSize(724.00),
                          width: size.width,
                          margin: getMargin(top: 24, bottom: 13),
                          child:
                            ...
                            Align(
                                ...
                                child: Padding(
                                    ...
                                    child: Obx(() => ListView.separated(
                                        ...
                                        itemCount: controller.paginationModelObj
                                            .value.paginationItemList.length,
                                        itemBuilder: (context, index) {
                                          PaginationItemModel model = controller
                                              .paginationModelObj
                                              .value
                                              .paginationItemList[index];
                                          return PaginationItemWidget(model);
                                        })))),
                            Align(
